...
static const char *dmenucmd[] = {"rofi", "-show", "drun", "-theme", "~/.config/rofi/nord.rasi"};
static const char *termcmd[]  = { "st", NULL };

static const char *printcmd[] = {"flameshot", "gui", NULL};
//static const char *virtcmd[] =  {"virt-viewer", "--attach", NULL};
static const char *virtcmd[] = {"/opt/looking-glass-B4/client/build/looking-glass-client", "-F", NULL};
//static const char *printcmd[] = {"reboot", NULL};

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY,             			XK_e, 	   spawn,          {.v = virtcmd } },
